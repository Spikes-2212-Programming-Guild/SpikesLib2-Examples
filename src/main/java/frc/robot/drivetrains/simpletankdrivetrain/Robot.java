...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        drivetrain = new TankDrivetrain(new MotorControllerGroup(
                new WPI_TalonSRX(RobotMap.CAN.DRIVETRAIN_LEFT_TALON_1), new WPI_TalonSRX(RobotMap.CAN.DRIVETRAIN_LEFT_TALON_2)),
                new MotorControllerGroup(
                        new WPI_TalonSRX(RobotMap.CAN.DRIVETRAIN_RIGHT_TALON_1), new WPI_TalonSRX(RobotMap.CAN.DRIVETRAIN_RIGHT_TALON_2)
                ));
